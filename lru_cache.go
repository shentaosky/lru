...
func (lru *LRUCache) Stats() (length, capacity int64, oldest time.Time) {
	...
	return int64(lru.list.Len()), lru.capacity, oldest
}
...
func (lru *LRUCache) updateInplace(element *list.Element, value string) {
...
func (lru *LRUCache) addNew(key string, value string) {
